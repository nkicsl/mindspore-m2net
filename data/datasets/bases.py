...
class BaseDataset(object):
    ...
    def get_imagedata_info(self, data):
        ...
        return num_pids, num_imgs, num_apps, num_cams
    ...
    def _check_before_run(self, *dirs):
        for dir in dirs:
...
class BaseImageDataset(BaseDataset):
    ...
    def print_dataset_statistics(self, train, query, gallery):
        num_train_pids, num_train_imgs, _, num_train_cams = self.get_imagedata_info(train)
        num_query_pids, num_query_imgs, _, num_query_cams = self.get_imagedata_info(query)
        num_gallery_pids, num_gallery_imgs, _, num_gallery_cams = self.get_imagedata_info(gallery)
