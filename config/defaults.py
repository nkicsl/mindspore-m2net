...
_C.DATALOADER.SAMPLER = 'pk'
# Number of instance for one batch
_C.DATALOADER.NUM_INSTANCE = 16

_C.DATALOADER.USE_TRANSFORMER = False
...
_C.SOLVER.GAMMA = 0.1
# MultiStepLR mitlstones
_C.SOLVER.STEPS = (30, 55)

# CosineAnnealingLR
_C.SOLVER.DELAY_EPOCHS = 30
_C.SOLVER.ETA_MIN_LR = 0.0000007

# Balanced weight of mat and appce loss
_C.SOLVER.MAT_LOSS_WEIGHT = 1.0
_C.SOLVER.APCE_LOSS_WEIGHT = 1.0
...
# Number of images per batch/Number of instance for one batch
# modify the two value together
_C.SOLVER.IDS_PER_BATCH = 4
